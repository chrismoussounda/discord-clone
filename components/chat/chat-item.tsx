import { Cross, Edit, FileIcon, ShieldAlert, ShieldCheck, Trash, X } from 'lucide-react';
...
import { EmojiPicker } from '../emogi-picker';
...
export const ChatItem = ({
  ...
  const canDeleteMessage = socketQuery?.channelId
    ? !deleted && (isOwner || isAdmin || isModerator)
    : isOwner;
          ...
          {!fileUrl && isEditing && (
            <Form {...form}>
              ...
              >
                ...
                />
                <Button disabled={isLoading || isDeleting} size="sm" variant="primary">
                  Save
                </Button>
              </form>
            </Form>
            ...
            <Trash
              onClick={() => {
                onOpen('deleteMessage', {
                  apiUrl: queryString.stringifyUrl({
                    url: socketUrl,
                    query: socketQuery,
                  }),
                });
